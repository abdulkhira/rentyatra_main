    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-3xl font-bold text-slate-800">Sub Category Management</h1>
                    <p className="text-slate-600 mt-1">Manage sub categories and their images</p>
                </div>
                <button
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200">
                <div className="p-6">
                    <h2 className="text-xl font-semibold text-slate-800 mb-4">Sub Categories</h2>
                    ...
                    {loading ? (
                        ...
                        <div className="text-center py-8">
                            ...
                            <h3 className="text-lg font-medium text-slate-700 mb-2">No sub category found</h3>
                            <p className="text-slate-500">Start by adding your first sub category.</p>
                        </div>
                    ) : (
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-8">
                    <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[95vh] overflow-y-auto">
                        <div className="p-6 border-b border-slate-200">
                            <div className="flex justify-between items-center">
                                <h2 className="text-2xl font-bold text-slate-800">Add New Sub Category</h2>
                                <button
                                        ...
                                        <div key={category.id} className="border border-slate-200 rounded-lg p-4 bg-slate-50">
                                            ...
                                            <div className="mb-4">
                                                ...
                                                <input
                                                    ...
                                                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:border-transparent ${validationErrors[category.id]
                                                        ? 'border-red-300 focus:ring-red-500'
                                                        : 'border-slate-300 focus:ring-blue-500'
                                                        }`}
                                                    placeholder="Enter sub category name (min 2 characters)"
                                                />
            ...
            {showEditForm && editingCategory && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-8">
                    <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[95vh] overflow-y-auto">
                        <div className="p-6 border-b border-slate-200">
                            <div className="flex justify-between items-center">
                                <h2 className="text-2xl font-bold text-slate-800">Edit Sub Category</h2>
                                <button
                        ...
                        <form onSubmit={handleEditSubmit} className="p-6 space-y-6">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-slate-700 mb-2">
                                    New Sub Category Images (will replace current images)
                                </label>
                                <input
                                    type="file"
                                    multiple
