  ...
  try {
    ...
    const rentalRequestData = {
      ...
      location: {
        ...
        coordinates: {
          latitude: parseFloat(parsedCoords.lat),
          longitude: parseFloat(parsedCoords.lng)
        },
    ...
    // 8. Background Task: Update User Subscription
    // We don't 'await' this so the response is faster
